...
const AppLayout = ({ children, title, currentPath }: AppLayoutProps) => {
  const sidebarLinks = [
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 md:ml-64 flex flex-col">
        ...
        <motion.header
          ...
          transition={{ duration: 0.5 }}
          className="hidden md:flex bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10"
        >
          <div className="px-4 sm:px-6 py-4 flex items-center justify-between w-full">
            <div className="flex items-center">
