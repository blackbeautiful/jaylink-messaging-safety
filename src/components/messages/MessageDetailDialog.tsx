...
const MessageDetailDialog = ({ open, onOpenChange, message }: MessageDetailProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`${isMobile ? 'w-[95vw] h-[90vh]' : 'max-w-4xl max-h-[85vh]'} p-0 overflow-hidden`}>
        <motion.div
        ...
        >
          {/* Header */}
          <DialogHeader className="px-6 py-4 border-b bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t bg-gray-50 dark:bg-gray-800">
            <div className="flex items-center space-x-2 text-xs text-gray-500">
              ...
              <span>Created: {formatDate(message.createdAt, { format: 'long' })}</span>
            </div>
